...
import 'package:remittance/presentation/features/dashboard/dashboard_screen/BankingTransferSuccessful.dart';
...
import 'package:remittance/core/utils/BankingSlider.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: boldTextStyle(
                  color:
                      appStore.isDarkModeOn ? white : Banking_TextColorPrimary,
                  size: 26),
            ).paddingAll(8),
            10.height,
